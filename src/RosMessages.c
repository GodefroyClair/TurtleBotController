...
int deserializeSensorState(unsigned char *inbuffer , RosSensorState *state)
{
    ...
    state->stamp.sec =  ((uint32_t) (*(inbuffer + offset)));
    state->stamp.sec |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
    state->stamp.sec |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
    state->stamp.sec |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
    
    offset += sizeof(state->stamp.sec);
    
    state->stamp.nsec =  ((uint32_t) (*(inbuffer + offset)));
    state->stamp.nsec |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
    state->stamp.nsec |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
    state->stamp.nsec |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
    
    offset += sizeof( state->stamp.nsec);
    
    state->bumper =  ((uint8_t) (*(inbuffer + offset)));
    offset += sizeof( state->bumper);
    state->cliff =  ((uint8_t) (*(inbuffer + offset)));
    offset += sizeof( state->cliff);
    state->button =  ((uint8_t) (*(inbuffer + offset)));
    offset += sizeof( state->button);
    union {
        int32_t real;
        uint32_t base;
    } u_left_encoder;
    ...
    state->left_encoder = u_left_encoder.real;
    offset += sizeof( state->left_encoder);
    union {
        int32_t real;
        uint32_t base;
    } u_right_encoder;
    ...
    state->right_encoder = u_right_encoder.real;
    offset += sizeof( state->right_encoder);
    union {
        float real;
        uint32_t base;
    } u_battery;
    ...
    state->battery = u_battery.real;
    offset += sizeof(state->battery);
